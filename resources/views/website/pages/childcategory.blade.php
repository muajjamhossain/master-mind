            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            @php
                                $maincat = App\Model\Category::find($category->parent->id);
                            @endphp
                            <li class="breadcrumb-item"><a href="{{ route('front.index') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('category_product', $maincat->parent->slug) }}">{{ $maincat->parent->name }}</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('sub_category_product', $category->parent->slug) }}">{{ $category->parent->name }}</a></li>
                        ...
                        @foreach ($category->products as $product)
                            <div class="col-md-4 col-lg-4 col-sm-6 col-12">
                                <div class="food_grocery_cont_dlt_all text-center">
                                    ...
                                    <h5>{{ Str::limit($product->name, 100) }}</h5>
