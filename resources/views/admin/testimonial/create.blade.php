...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        ...
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}ute('')}}">Dashboard</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{route('testimonial.insert')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add Client Testimonial Information</h3>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> add testimonial information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group{{ $errors->has('review') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <textarea class="form-control" rows="5" name="review">{{old('review')}}</textarea>
