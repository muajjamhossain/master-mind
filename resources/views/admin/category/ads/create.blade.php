...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{ route('category.ads') }}">ads</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="POST" action="{{route('category.ads.insert')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add category Ads Information</h3>
                      </div>
                      <div class="col-md-4 text-right">
                          <a href="{{route('categoryads')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-th"></i> All Category Ads</a>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> upload category ads information.
                          </div>
                        @endif
                ...
                <div class="form-group row custom_form_group{{ $errors->has('image') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">ads Image (1349 x 562):<span class="req_star">*</span></label>
                    <div class="col-sm-4">
