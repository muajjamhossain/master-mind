...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Physical Product</li>
        </ol>
    </div>
</div>
<div class="row">
        ...
        <form class="form-horizontal" method="POST" action="{{route('product.insert')}}" enctype="multipart/form-data">
          ...
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add Physical Product</h3>
                      </div>
              ...
              <div class="card-body card_form">
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> Upload Physical Product.
                          </div>
                        @endif
                ...
                <div class="condtition form-group d-none row custom_form_group{{ $errors->has('conditions') ? ' has-error' : '' }}">
                ...
                <div class="form-group row custom_form_group">
                    <label class="col-sm-3 control-label"><span class="req_star"></span></label>
                    <div class="col-sm-7">
                        <input type="checkbox" name="checkshiptime" id="shiptime" ><label for="shiptime" style="font-weight: 16px; margin-left:7px;cursor: pointer;">Allow Eshitimeted Shipping Time</label>
                    </div>
                </div>

                <div class="checkshiptime form-group d-none row custom_form_group{{ $errors->has('ship_time') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label">Product Delevery Time:<span class="req_star">*</span></label>
                    <div class="col-sm-7">
                     <input type="text" name="ship_time" class="form-control" value="{{ old('ship_time') }}">
                ...
                <div class="form-group row custom_form_group">
                    <label class="col-sm-3 control-label"><span class="req_star"></span></label>
                    <div class="col-sm-7">
                        <input type="checkbox" name="checksize"  id="size" ><label for="size" style="font-weight: 16px; margin-left:7px;cursor: pointer;">Allow Product Size</label>
                    </div>
                </div>

                <div class="checksize form-group d-none row custom_form_group{{ $errors->has('size') ? ' has-error' : '' }}">
                    <label class="col-sm-3 control-label"><span class="req_star"></span></label>
                    <div class="col-sm-7">
                    <div id="mainsize">
                        <div class="row">
