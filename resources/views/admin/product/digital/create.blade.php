...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="active">Digital Product</li>
        </ol>
    </div>
</div>
<div class="row">
        ...
        <form class="form-horizontal" method="POST" action="{{route('product.insert')}}" enctype="multipart/form-data">
          ...
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Add Digital Product</h3>
                      </div>
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                       <select name="file_type" id="" class="form-control" value="{{old('file_type')}}">
                ...
                <div class="uploadLink form-group d-none row custom_form_group{{ $errors->has('upload_link') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="text" type="file" name="upload_link" class="form-control" value="{{old('upload_link')}}">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <textarea cols="68" rows="4" name="description">{{old('description')}}</textarea>
                ...
                <div class="form-group row custom_form_group{{ $errors->has('policy') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                        <textarea cols="68" rows="4" name="policy">{{old('policy')}}</textarea>
