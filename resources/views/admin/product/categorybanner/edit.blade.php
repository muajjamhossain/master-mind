...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li><a href="{{ route('category.banners') }}">Category Banners</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="POST" action="{{route('category.banner.update')}}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      <div class="col-md-8">
                          <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i>Edit category Banner Information</h3>
                      </div>
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group{{ $errors->has('title') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <select name="category_id" id="" class="form-control">
                          ...
                          <option value="{{ $key }}" @if($key == $banner->category_id) selected @endif>{{ $item }}</option>
                          @endforeach
                      </select>
                      @if ($errors->has('title'))
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="discount" value="{{ $banner->discount }}">
                    </div>
                </div>
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" name="button_url" value="{{ $banner->url }}">
                    </div>
                </div>
                <div class="form-group row custom_form_group{{ $errors->has('image') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                      ...
                      @endif
                      <img src="{{ URL::to($banner->image) }}" id='img-upload'/>
                    </div>
                </div>
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-7">
                        <div class="checkcontent d-flex">
                            <input type="checkbox" style="width: 20px" @if ($banner->check_content == 1) selected @endif class="form-control mb-1" name="checkcontent">
                            <span class="ml-2 mt-1"> If you used only image without content</span>
                        </div>
                    </div>
                </div>
              </div>
