...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Banners</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active">Category Banners</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> All Category Banner Information</h3>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{route('category.banner.add')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Add Banner</a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        @if(Session::has('success_unpublish'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Successfully!</strong> unpublish banner information.
                          </div>
                        @endif
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <a href="{{route('category.banner.view',$data->id)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                            <a href="{{route('category.banner.edit', $data->id)}}" title="edit"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
