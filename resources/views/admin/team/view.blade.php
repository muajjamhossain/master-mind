            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{route('teams')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-th"></i> All Team Member</a>
                    </div>
                    ...
                    <div class="col-md-8">
                        <table class="table table-bordered table-striped table-hover custom_view_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($data->image!='')
                                        <img class="table_image_ban_big" src="{{URL::to($data->photo)}}" alt="image"/>
                                    @else
