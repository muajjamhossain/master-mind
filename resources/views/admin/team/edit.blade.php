...
<div class="row">
    <div class="col-lg-12">
        <form class="form-horizontal" method="post" action="{{route('team.update')}}" enctype="multipart/form-data">
          @csrf
          <div class="card">
              <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-4 text-right">
                          <a href="{{route('teams')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-th"></i> All Team</a>
                      </div>
              ...
              <div class="card-body card_form">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-2">
                        @if($data->image!='')
                            <img class="img-thumbnail" src="{{URL::to($data->photo)}}" alt="photo"/>
                        @else
                            <img class="img-thumbnail" src="{{asset('public/uploads')}}/no-image-big.jpg" alt="photo"/>
                        @endif
                    </div>
                </div>
              </div>
