            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{route('team.add')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Add Team</a>
                    </div>
                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{Str::words($data->details,5)}}</td>
                                        <td>
                                            @if($data->image!='')
                                        ...
                                        <td>
                                            <a href="{{route('team.view',$data->id)}}" title="view"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                            <a href="{{route('team.edit',$data->id)}}" title="edit"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
...
<div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{route('team.softdelete')}}"/>
              @csrf
              <div class="card mb-0">
                <div class="card-header">
